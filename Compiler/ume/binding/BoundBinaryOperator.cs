...
namespace Ume.Binding
{
    internal sealed class BoundBinaryOperator
    {
        ...
        private BoundBinaryOperator(SyntaxKind syntaxKind, BoundBinaryOperatorKind kind, Type operantType, Type reultType) : this(syntaxKind, kind, operantType, operantType, reultType) { }
